    ...
    ICurrentUser currentUser) : ControllerBase
{
        ...
        [FromBody] CreatePropertyRequest request, CancellationToken ct)
    {
        ...
        var cmd = new CreatePropertyCommand(landlord.Id, request.Name, request.Address, request.UnitNumber);
        ...
        CancellationToken ct = default)
    {
        ...
        var result = await getLandlordProperties.Handle(
            new GetLandlordPropertiesQuery(landlord.Id, page, pageSize), ct);
        return Ok(result);
    }
}
