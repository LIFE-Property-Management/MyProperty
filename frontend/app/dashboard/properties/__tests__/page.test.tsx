...
// so we mock the hook and feed it a query-result shape per test. With the hook
// stubbed there is no real useQuery call, so no QueryClientProvider is needed.
// DataTable / Pagination / Spinner / Card render for real — we assert against
// their output. Mirrors the pattern in app/dashboard/__tests__/LandlordDashboard.test.tsx.
