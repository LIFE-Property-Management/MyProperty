    ...
    <nav className="bg-surface border-b border-border">
      <div className="mx-auto max-w-7xl px-4 md:px-6 h-14 flex items-center justify-between gap-4">
        ...
        <button
          ...
          onClick={() => setOpen((v) => !v)}
        >
          <span aria-hidden className="block w-5 h-0.5 bg-current relative before:absolute before:left-0 before:-top-1.5 before:w-5 before:h-0.5 before:bg-current after:absolute after:left-0 after:top-1.5 after:w-5 after:h-0.5 after:bg-current" />
        </button>
      </div>
